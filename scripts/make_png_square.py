...
pad_all_folder("assets/images/units/summon")
...
pad_all_folder("assets/images/units/summon/battle")
pad_all_folder("assets/images/weapons/common")
pad_all_folder("assets/images/weapons/uncommon")
pad_all_folder("assets/images/weapons/rare")
